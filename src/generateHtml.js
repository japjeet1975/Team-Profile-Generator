...
return`
<div class="col">
<div class="card border-dark m-3 mx-auto bg-warning" style="width: 18rem;">
    <div class="card-body bg-success mt-3 text-light">
    ...
    <ul class="list-group list-group-flush mb-3">
      ...
      <li class="list-group-item">Office No: ${manager.phoneNumber}</li>
    </ul>
  </div>
</div> 
...
const generateTeamPage = function(infobox){
	...
	<section>
	    <div class="container">
		<div class="row text-light m-5 p-3 bg-warning">
